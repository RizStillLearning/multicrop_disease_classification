"""
predict.py — DenseNet-121 + CBAM + SVM inference

Usage (from project root):
    python densenet121_cbam_svm/scripts/predict.py <path_to_image>
...
class DenseNet121CBAMFeatureExtractor(nn.Module):
    def __init__(self, backbone):
        super().__init__()
        self.features = backbone.features       # includes CBAM wrappers
