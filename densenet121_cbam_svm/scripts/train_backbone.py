...
def build_model(num_classes):
    return get_cbam_densenet121(num_classes=num_classes, pretrained=True)
...
def main():
    seed_everything()
    config_name = 'densenet121_cbam_svm/config.yaml'
    ...
    plt.ylabel('True')
    plt.title('DenseNet-121 + CBAM Backbone Confusion Matrix')
